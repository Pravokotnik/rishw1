...
{
  new (message_memory) tutorial_interfaces::msg::CustomMessage(_init);
}

void CustomMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces::msg::CustomMessage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomMessage_message_member_array[3] = {
  {
    ...
    offsetof(tutorial_interfaces::msg::CustomMessage, text),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::msg::CustomMessage, number),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::msg::CustomMessage, flag),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomMessage_message_members = {
  ...
  3,  // number of fields
  sizeof(tutorial_interfaces::msg::CustomMessage),
...
get_message_type_support_handle<tutorial_interfaces::msg::CustomMessage>()
{
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::CustomMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, msg, CustomMessage)() {
  return &::tutorial_interfaces::msg::rosidl_typesupport_introspection_cpp::CustomMessage_message_type_support_handle;
}
