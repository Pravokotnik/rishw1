...
bool tutorial_interfaces__msg__custom_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.msg._custom_message.CustomMessage", full_classname_dest, 53) == 0);
  }
  tutorial_interfaces__msg__CustomMessage * ros_message = _ros_message;
  {  // text
...
PyObject * tutorial_interfaces__msg__custom_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.msg._custom_message");
