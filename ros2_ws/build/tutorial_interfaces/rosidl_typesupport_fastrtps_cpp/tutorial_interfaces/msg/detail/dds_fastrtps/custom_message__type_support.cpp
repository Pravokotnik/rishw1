...
#include "tutorial_interfaces/msg/detail/custom_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::msg::CustomMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::msg::CustomMessage & ros_message)
{
  // Member: text
  cdr >> ros_message.text;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tutorial_interfaces::msg::CustomMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::msg::CustomMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::msg::CustomMessage *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_CustomMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, msg, CustomMessage)() {
  return &tutorial_interfaces::msg::typesupport_fastrtps_cpp::_CustomMessage__handle;
}
