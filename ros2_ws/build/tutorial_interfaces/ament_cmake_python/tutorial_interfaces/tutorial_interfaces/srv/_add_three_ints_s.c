...
bool tutorial_interfaces__srv__add_three_ints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // f
    ...
    assert(PyLong_Check(field));
    ros_message->f = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // g
  ...
  {  // h
    ...
    assert(PyLong_Check(field));
    ros_message->h = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // i
  ...
  {  // j
    ...
    assert(PyLong_Check(field));
    ros_message->j = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * tutorial_interfaces__srv__add_three_ints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // f
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->f);
    {
  ...
  {  // h
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->h);
    {
  ...
  {  // j
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->j);
    {
